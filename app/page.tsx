...
const TURKISH_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-turkish-edition?ref=release";
...
const ARABIC_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-arabic-edition?ref=release";
const AMERICAN_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-american-edition?ref=release";
const PERSIAN_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-persian-edition?ref=release";
const HEBREW_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-hebrew-edition?ref=release";
const HINDI_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-hindi-edition?ref=release";
const CHINESE_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-chinese-edition?ref=release";
const JAPANESE_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-japanese-edition?ref=release";
const SOUTH_KOREAN_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-south-korean-edition?ref=release";
const RUSSIAN_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-russian-edition?ref=release";
const PORTUGUESE_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-portuguese-edition?ref=release";
const UK_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-uk-edition?ref=release";
const WORLD_EDITION_URL = "https://distrokid.com/hyperfollow/unitedhumanity/imagine-humanity-wins-world-edition?ref=release";
...
const editionUrls: Record<string, string> = {
  ...
  TR: TURKISH_EDITION_URL,
  GR: GREEK_EDITION_URL,
  IT: ITALIAN_EDITION_URL,
  FR: FRENCH_EDITION_URL,
  ES: SPANISH_EDITION_URL,
  BR: BRAZIL_EDITION_URL,
  AR: ARABIC_EDITION_URL,
  US: AMERICAN_EDITION_URL,
  IR: PERSIAN_EDITION_URL,
  IL: HEBREW_EDITION_URL,
  IN: HINDI_EDITION_URL,
  CN: CHINESE_EDITION_URL,
  JP: JAPANESE_EDITION_URL,
  KR: SOUTH_KOREAN_EDITION_URL,
  RU: RUSSIAN_EDITION_URL,
  PT: PORTUGUESE_EDITION_URL,
  UK: UK_EDITION_URL,
  WORLD: WORLD_EDITION_URL,
};

const liveCopy: Record<Lang, { badge: string; title: string; listen: string; next: string }> = {
  de: { badge: "JETZT VERÖFFENTLICHT", title: "World Edition ist live", listen: "Jetzt anhören", next: "Nächste Edition" },
  en: { badge: "OUT NOW", title: "World Edition is live", listen: "Listen now", next: "Next edition" },
  fr: { badge: "DISPONIBLE MAINTENANT", title: "La World Edition est en ligne", listen: "Écouter maintenant", next: "Prochaine édition" },
  es: { badge: "YA DISPONIBLE", title: "La World Edition ya está disponible", listen: "Escuchar ahora", next: "Próxima edición" },
  bs: { badge: "SADA DOSTUPNO", title: "World Edition je objavljena", listen: "Slušaj sada", next: "Sljedeće izdanje" },
};
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="releaseStory"><div><p className="sectionNo">02 — THE RELEASE</p><h2>{t.releaseTitle}</h2><p>{t.releaseCopy}</p></div><div className="platforms" aria-label="Music platforms">{["Spotify", "Apple Music", "Amazon Music", "YouTube Music", "Deezer"].map(platform => <a href={WORLD_EDITION_URL} target="_blank" rel="noopener noreferrer" key={platform}>{platform}<small>{live.listen} ↗</small></a>)}</div></section>
    ...
    <section className="wallSection" id="wall"><div className="sectionHeading"><p className="sectionNo">07 — {s.wallKicker}</p><h2>{s.wallTitle}</h2><p>{s.wallLead}</p></div><div className="foundingWall"><div className="foundingHeader"><span>2026</span><h3>{s.foundingTitle}</h3><p>{s.foundingLead}</p></div><div className="wallEmpty"><div className="flagRibbon" aria-hidden="true"><span>🇩🇪</span><span>🇧🇦</span><span>🇺🇦</span><span>🇵🇱</span><span>🇹🇷</span><span>🇬🇷</span><span>🇮🇹</span><span>🇫🇷</span><span>🇪🇸</span><span>🇧🇷</span><span>🇯🇵</span><span>🇺🇸</span></div><article className="supporterSpotlight"><p className="supporterBadge">Unterstützer der ersten Stunde</p><h4>Denny Böhme</h4><p className="supporterLocation">Deutschland · Gemeinsam mit</p><div className="supporterCompanies"><a href="https://www.kreditwelt.de/" target="_blank" rel="noopener noreferrer" aria-label="Kreditwelt GmbH besuchen"><img src="/kreditwelt-logo.svg" alt="Kreditwelt GmbH"/><span>Kreditwelt GmbH ↗</span></a><a href="https://www.sanierungswelt.immo/" target="_blank" rel="noopener noreferrer" aria-label="Sanierungswelt UG besuchen"><img src="/sanierungswelt-logo.svg" alt="Sanierungswelt UG"/><span>Sanierungswelt UG ↗</span></a></div></article><p>{s.equality}</p></div></div></section>
